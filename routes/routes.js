...
router.post('/user', AdminAuth, UserController.create);//serve para enviar informações para o banco
router.get("/user", AdminAuth, UserController.index);//vai retornar todos os usuarios
router.get("/user/:id",AdminAuth,UserController.findUser);// buscar pelo id
